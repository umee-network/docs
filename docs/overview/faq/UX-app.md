...
_However, the accrued interest will grow over time, so it’s recommended to pay off small amounts from time to time, to ensure your health factor does not decrease heavily. ([see borrow APR](https://learning.ux.xyz/learn-the-basics/UX-basics/common-terms.html#borrow-apr))._
...
_Understanding financial terms is crucial, you can find a comprehensive list with commonly used terms and their explanation [here](https://learning.ux.xyz/learn-the-basics/UX-basics/common-terms.html)._
