...
There are several indexer solutions available, each offering different levels of decentralisation, ease of development, and performance for you to consider. These solutions serve as intermediaries to assist in indexing the UmeeX network.
...
- [UmeeX Starter Project](https://github.com/subquery/cosmos-subql-starter/tree/main/UmeeX/umeex-starter)

### Running and Hosting your UmeeX SubQuery APIs
