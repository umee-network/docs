...
There are several indexer solutions available, each offering different levels of decentralisation, ease of development, and performance for you to consider. These solutions serve as intermediaries to assist in indexing the Umee network.
...
- [Umee Starter Project](https://github.com/subquery/cosmos-subql-starter/tree/main/Umee/umee-starter)

### Running and Hosting your Umee SubQuery APIs
